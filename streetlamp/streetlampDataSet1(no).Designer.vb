...
<System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "2.0.0.0"),  _
 ...
 System.Xml.Serialization.XmlRootAttribute("streetlampDataSet1"),  _
 System.ComponentModel.Design.HelpKeywordAttribute("vs.data.DataSet")>  _
Partial Public Class streetlampDataSet1
    ...
    Public Overrides Function Clone() As System.Data.DataSet
        Dim cln As streetlampDataSet1 = CType(MyBase.Clone,streetlampDataSet1)
        cln.InitVars
    ...
    Private Sub InitClass()
        Me.DataSetName = "streetlampDataSet1"
        Me.Prefix = ""
        Me.Namespace = "http://tempuri.org/streetlampDataSet1.xsd"
    ...
    Public Shared Function GetTypedDataSetSchema(ByVal xs As System.Xml.Schema.XmlSchemaSet) As System.Xml.Schema.XmlSchemaComplexType
        Dim ds As streetlampDataSet1 = New streetlampDataSet1
    ...
    Partial Public Class service_recordDataTable
        ...
        Private columnrecord_id As System.Data.DataColumn
        
        Private columnlamp_id As System.Data.DataColumn
        
        Private columnproblem_inf As System.Data.DataColumn
        
        Private columnopen_time As System.Data.DataColumn
        
        Private columnclose_time As System.Data.DataColumn
        
        Private columnhappen_time As System.Data.DataColumn
        ...
        <System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
        Public ReadOnly Property record_idColumn() As System.Data.DataColumn
            Get
        ...
        <System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
        Public ReadOnly Property problem_infColumn() As System.Data.DataColumn
            Get
        ...
        <System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
        Public ReadOnly Property happen_timeColumn() As System.Data.DataColumn
            Get
                Return Me.columnhappen_time
            End Get
        End Property
        ...
        <System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
        Public Overloads Function Addservice_recordRow(ByVal lamp_id As String, ByVal problem_inf As String, ByVal open_time As Date, ByVal close_time As Date, ByVal happen_time As Date) As service_recordRow
            Dim rowservice_recordRow As service_recordRow = CType(Me.NewRow,service_recordRow)
            rowservice_recordRow.ItemArray = New Object() {Nothing, lamp_id, problem_inf, open_time, close_time, happen_time}
        ...
        Friend Sub InitVars()
            ...
            Me.columnhappen_time = MyBase.Columns("happen_time")
        End Sub
        
        <System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
        Private Sub InitClass()
            Me.columnrecord_id = New System.Data.DataColumn("record_id", GetType(Integer), Nothing, System.Data.MappingType.Element)
            ...
            Me.columnproblem_inf = New System.Data.DataColumn("problem_inf", GetType(String), Nothing, System.Data.MappingType.Element)
            ...
            Me.columnhappen_time = New System.Data.DataColumn("happen_time", GetType(Date), Nothing, System.Data.MappingType.Element)
            MyBase.Columns.Add(Me.columnhappen_time)
            Me.columnrecord_id.AutoIncrement = true
            Me.columnrecord_id.AllowDBNull = false
            Me.columnrecord_id.ReadOnly = true
    ...
    Partial Public Class service_recordRow
        ...
        Public Property record_id() As Integer
            Get
                Return CType(Me(Me.tableservice_record.record_idColumn),Integer)
            End Get
            Set
                Me(Me.tableservice_record.record_idColumn) = value
            End Set
        End Property
        ...
        Public Property problem_inf() As String
            Get
                Try 
                    Return CType(Me(Me.tableservice_record.problem_infColumn),String)
                Catch e As System.InvalidCastException
                    Throw New System.Data.StrongTypingException("表““service_record””中列““problem_inf””的值为 DBNull。", e)
                End Try
            End Get
            Set
                Me(Me.tableservice_record.problem_infColumn) = value
            End Set
        End Property
        ...
        <System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
        Public Property happen_time() As Date
            Get
                Try 
                    Return CType(Me(Me.tableservice_record.happen_timeColumn),Date)
                Catch e As System.InvalidCastException
                    Throw New System.Data.StrongTypingException("表““service_record””中列““happen_time””的值为 DBNull。", e)
                End Try
            End Get
            Set
                Me(Me.tableservice_record.happen_timeColumn) = value
            End Set
        End Property
        
        <System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
        Public Function Isproblem_infNull() As Boolean
            Return Me.IsNull(Me.tableservice_record.problem_infColumn)
        End Function
        
        <System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
        Public Sub Setproblem_infNull()
            Me(Me.tableservice_record.problem_infColumn) = System.Convert.DBNull
        End Sub
        ...
        <System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
        Public Function Ishappen_timeNull() As Boolean
            Return Me.IsNull(Me.tableservice_record.happen_timeColumn)
        End Function
        
        <System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
        Public Sub Sethappen_timeNull()
            Me(Me.tableservice_record.happen_timeColumn) = System.Convert.DBNull
        End Sub
    End Class
...
Namespace streetlampDataSet1TableAdapters
    ...
    Partial Public Class service_recordTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            tableMapping.ColumnMappings.Add("happen_time", "happen_time")
            Me._adapter.TableMappings.Add(tableMapping)
            Me._adapter.InsertCommand = New System.Data.SqlClient.SqlCommand
            Me._adapter.InsertCommand.Connection = Me.Connection
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[service_record] ([lamp_id], [problem_inf], [open_time], [close"& _ 
                "_time], [happen_time]) VALUES (@lamp_id, @problem_inf, @open_time, @close_time, "& _ 
                "@happen_time)"
            ...
            Me._adapter.InsertCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@problem_inf", System.Data.SqlDbType.NChar, 0, System.Data.ParameterDirection.Input, 0, 0, "problem_inf", System.Data.DataRowVersion.Current, false, Nothing, "", "", ""))
            ...
            Me._adapter.InsertCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@happen_time", System.Data.SqlDbType.DateTime, 0, System.Data.ParameterDirection.Input, 0, 0, "happen_time", System.Data.DataRowVersion.Current, false, Nothing, "", "", ""))
        End Sub
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT record_id, lamp_id, problem_inf, open_time, close_time, happen_time FROM d"& _ 
                "bo.service_record"
            Me._commandCollection(0).CommandType = System.Data.CommandType.Text
            Me._commandCollection(1) = New System.Data.SqlClient.SqlCommand
            Me._commandCollection(1).Connection = Me.Connection
            Me._commandCollection(1).CommandText = "SELECT record_id, lamp_id, problem_inf, open_time, close_time, happen_time"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM "& _ 
                "service_record"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"WHERE (lamp_id = @Param1)"
            ...
            Me._commandCollection(2).CommandText = "SELECT record_id, lamp_id, problem_inf, open_time, close_time, happen_time"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM "& _ 
                "service_record"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"WHERE (close_time IS NOT NULL)"
        ...
        Public Overloads Overridable Function Fill(ByVal dataTable As streetlampDataSet1.service_recordDataTable) As Integer
        ...
        Public Overloads Overridable Function GetData() As streetlampDataSet1.service_recordDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim dataTable As streetlampDataSet1.service_recordDataTable = New streetlampDataSet1.service_recordDataTable
        ...
        Public Overloads Overridable Function FillBy_find(ByVal dataTable As streetlampDataSet1.service_recordDataTable, ByVal Param1 As String) As Integer
        ...
        Public Overloads Overridable Function GetDataBy1(ByVal Param1 As String) As streetlampDataSet1.service_recordDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(1)
            If (Param1 Is Nothing) Then
                Throw New System.ArgumentNullException("Param1")
            Else
        ...
        <System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Fill, false)>  _
        Public Overloads Overridable Function FillBy_finish(ByVal dataTable As streetlampDataSet1.service_recordDataTable) As Integer
        ...
        <System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.[Select], false)>  _
        Public Overloads Overridable Function GetDataBy() As streetlampDataSet1.service_recordDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(2)
            Dim dataTable As streetlampDataSet1.service_recordDataTable = New streetlampDataSet1.service_recordDataTable
            Me.Adapter.Fill(dataTable)
            Return dataTable
        ...
        <System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataTable As streetlampDataSet1.service_recordDataTable) As Integer
            Return Me.Adapter.Update(dataTable)
        End Function
        
        <System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataSet As streetlampDataSet1) As Integer
        ...
        Public Overloads Overridable Function Insert(ByVal lamp_id As String, ByVal problem_inf As String, ByVal open_time As System.Nullable(Of Date), ByVal close_time As System.Nullable(Of Date), ByVal happen_time As System.Nullable(Of Date)) As Integer
            If (lamp_id Is Nothing) Then
                Throw New System.ArgumentNullException("lamp_id")
            Else
                Me.Adapter.InsertCommand.Parameters(0).Value = CType(lamp_id,String)
            End If
            If (problem_inf Is Nothing) Then
                Me.Adapter.InsertCommand.Parameters(1).Value = System.DBNull.Value
            Else
                Me.Adapter.InsertCommand.Parameters(1).Value = CType(problem_inf,String)
            End If
            If (open_time.HasValue = true) Then
                Me.Adapter.InsertCommand.Parameters(2).Value = CType(open_time.Value,Date)
            Else
                Me.Adapter.InsertCommand.Parameters(2).Value = System.DBNull.Value
            End If
            If (close_time.HasValue = true) Then
                Me.Adapter.InsertCommand.Parameters(3).Value = CType(close_time.Value,Date)
            Else
                Me.Adapter.InsertCommand.Parameters(3).Value = System.DBNull.Value
            End If
            If (happen_time.HasValue = true) Then
                Me.Adapter.InsertCommand.Parameters(4).Value = CType(happen_time.Value,Date)
            Else
